                                ...
                                <table id="rci_line_items" class="table-sm table-striped rcidata-list">
                                    ...
                                    <tbody>
                                        <tr style="display:none;">
                                            ...
                                            <td class="text-center align-middle" nowrap>
                                                <input type="number"  value="" step="any"  name="philheath_amount" data-dtid=""  class="philheath_amount text-center"/>
                                            </td>
                                            <td class="text-center align-middle" nowrap>
...
foreach ($lddapadadata as $data) {
    ...
    $lddapada[] = [
        ...
        'philheath_amount'   => $data['philheath_amount'],
    ...
    if (!$(this).data("ui-autocomplete")) {
        ...
        $(this).autocomplete({
            ...
            select: function (event, ui) {
                ...
                row.find('.philheath_amount').val(ui.item.philheath_amount);
