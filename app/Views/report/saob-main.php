                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row mb-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="Department" name="Department" value="" class="form-control form-control-sm" readonly />
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="Agency" name="Agency" value="" class="form-control form-control-sm" readonly />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                                            ...
                                            <table id="budget_indirect_line_items" class="table-sm table-striped budgetdata-indirect-list">
                                                ...
                                                <tbody>
                                                    <tr style="display:none;">
                                                        ...
                                                        <td class="text-center align-middle" nowrap>
                                                            <input type="number" id="r1_approved_budget"  value="" size="25" step="any" name="r1_approved_budget" data-dtid="" class="r1_approved_budget text-center" disabled onchange="__mysys_saob_rpt_ent.__indirect_ps_totals(); __mysys_saob_rpt_ent.__combined_totals();" onmouseout="__mysys_saob_rpt_ent.__indirect_ps_totals(); __mysys_saob_rpt_ent.__combined_totals();"/>
                                                        </td>
                                                    </tr>
                                                    <?php if(!empty($recid)):
                                                        $query = $this->db->query("
